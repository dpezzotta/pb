...
$clid = $_GET['clid'];
$teacher_id_selected = $_GET['teacher_id'];
$admin = new Admin();
$students = $admin->get_awards_by_clid($clid, $teacher_id_selected);
...
// 	  $this->Cell(0,4,'visit PlanetBravo.com/badges/'.$badge_username.' to view your accomplishments',0,1,'C',0,$badge_path);
	...
	$this->Ln(10);
	$this->SetFont('Arial','B',12);
	$this->Cell(0,6,'Techno-tainment Camp',0,0,'C');
...
$file = "tmp_pdf/awards_$clid"."_"."$date.pdf";
$pdf->Output($file);
